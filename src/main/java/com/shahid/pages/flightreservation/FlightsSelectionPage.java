package com.shahid.pages.flightreservation;
import com.shahid.pages.AbstractPage;
...
public class FlightsSelectionPage extends AbstractPage {
    ...
    public void selectFlights(){
        int random = ThreadLocalRandom.current().nextInt(1, departureFlightsOptions.size());
        this.departureFlightsOptions.get(random).click();
        this.arrivalFlightsOptions.get(random-1).click();
    }
